...
import { findScene } from "../stores/projectsStore.js";
...
function normalizeLightingControls(rawControls) {
  ...
  rawControls.forEach((item) => {
    ...
    const isOn = typeof item.isOn === "boolean" ? item.isOn : true;
    ...
    <div className="page page-project-detail">
      ...
      <section className="project-detail-main">
          ...
          <div className="project-detail-side">
            ...
            <div className="project-detail-panel">
              ...
              <textarea
                ...
                onBlur={(e) => {
                  setMemoText(normalizeHalfWidthAlphanumerics(e.target.value));
                }}
        ...
        <div className="project-detail-footer">
          ...
          <div className="page-number">{sceneId?.match(/\d+/)?.[0] ?? ""}</div>
        </div>
      </section>
    </div>
  );
